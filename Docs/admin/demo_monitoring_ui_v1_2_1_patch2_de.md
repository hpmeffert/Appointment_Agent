...
`v1.2.1-patch2` behebt zwei Onboarding-Probleme:
- Buttons im Day Mode waren zu schwer erkennbar
- die Dokumentation rund um Cockpit und LEKAB Settings war zu duenn
...
![Annotierte Cockpit-Uebersicht](/docs/assets/screenshots/v1_2_1_patch2/cockpit-overview.svg)
...
![Annotierte RCS-Settings-Seite](/docs/assets/screenshots/v1_2_1_patch2/rcs-settings.svg)
