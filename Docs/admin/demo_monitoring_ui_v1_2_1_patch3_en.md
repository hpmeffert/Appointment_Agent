...
`v1.2.1-patch3` keeps the Patch 2 UI and documentation fixes and adds direct platform clarity inside the cockpit.
...
## New patch 3 cockpit panels

- `How the Platform Works`
  Shows channels, LEKAB, service bus, orchestrator, and adapters.
- `Demo Storyboard`
  Shows the five core stories with business value and wow effect.
- `Help`
  Repeats platform clarity, storyboard, business value, and documentation links in one page.
