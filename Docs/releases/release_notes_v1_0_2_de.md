# Release Notes v1.0.2 (DE)

- Demo-UI fuer Live-Praesentationen mit klareren Controls und staerkerem Storytelling verbessert.
- Orchestrator-Google-Integration in den `v1.0.2` Release-Stand uebernommen, damit die Demo auf dem aktuellen internen Ablauf aufsetzt.
- Sprachumschaltung in der Demo-UI fuer Englisch und Deutsch hinzugefuegt.
