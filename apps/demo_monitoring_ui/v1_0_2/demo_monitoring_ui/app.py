...
router = APIRouter(tags=["demo-monitoring-ui-v1.0.2"])
...
def _render_v102_html() -> str:
    html = SOURCE_HTML.read_text(encoding="utf-8")
    return html.replace("v1.0.0", "v1.0.2")


@router.get("/ui/demo-monitoring/v1.0.2")
def demo_ui() -> HTMLResponse:
    return HTMLResponse(_render_v102_html())


@router.get("/api/demo-monitoring/v1.0.2/help")
def help_view() -> dict:
    return {
...
@router.get("/api/demo-monitoring/v1.0.2/scenarios")
