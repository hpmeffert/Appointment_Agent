...
router = APIRouter(tags=["demo-monitoring-ui-v1.1.0-patch1"])
...
def _render_patch_html() -> str:
    ...
    html = html.replace("v1.0.0", "v1.1.0-patch1")
    html = html.replace("Release shown: v1.0.4 Patch 2", "Release shown: v1.1.0 Patch 1")
    html = html.replace("Gezeigter Release: v1.0.4 Patch 2", "Gezeigter Release: v1.1.0 Patch 1")
    return html


@router.get("/ui/demo-monitoring/v1.1.0-patch1")
def demo_ui() -> HTMLResponse:
    return HTMLResponse(_render_patch_html())


@router.get("/api/demo-monitoring/v1.1.0-patch1/help")
...
@router.get("/api/demo-monitoring/v1.1.0-patch1/scenarios")
