...
def build_v135_payload(lang: str = "en") -> dict:
    ...
    payload = {
        ...
        "runtime_health": {
            "db_status": "ok",
            "worker_status": "ready",
            "next_due_at": "2026-04-20T08:30:00+02:00",
            "active_job_count": 3,
            "reclaimable_locks": 0,
            "last_job_activity_at": "2026-04-20T08:28:00+02:00",
            "last_message_activity_at": "2026-04-20T08:32:00+02:00",
            "last_audit_activity_at": "2026-04-20T08:33:00+02:00",
            "health_notes": [
                (
                    "No reclaimable dispatch locks are waiting."
                    if language == "en"
                    else "Es warten keine abgelaufenen Dispatch-Locks."
                ),
                (
                    "The next reminder is already visible for the operator."
                    if language == "en"
                    else "Die naechste Erinnerung ist fuer den Operator bereits sichtbar."
                ),
            ],
        },
        "help_links": [
        ...
        "ui_api_links": [
            "/api/reminder-ui/v1.3.5/payload",
            "/api/reminder-ui/v1.3.5/help",
            "/api/reminder-ui/v1.3.5/config",
            "/api/reminder-ui/v1.3.5/config/preview",
            "/api/reminder-ui/v1.3.5/results",
        ],
        "api_links": [
            "/api/reminder-ui/v1.3.5/payload",
            "/api/reminder-ui/v1.3.5/help",
        ...
        "docs_highlights": [
            ...
            (
                "The health view now explains what is scheduled next and when the system was last active."
                if language == "en"
                else "Die Health-Sicht erklaert jetzt, was als Naechstes geplant ist und wann das System zuletzt aktiv war."
            ),
        ],
        "delivery_states": [
            "sent",
