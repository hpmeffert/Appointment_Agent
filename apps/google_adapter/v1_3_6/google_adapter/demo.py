...
APPOINTMENT_BLUEPRINTS: dict[str, dict[str, Any]] = {
    ...
    "doctor": {
        ...
        "customer_name": "Julia Neumann",
        "customer_contact": "+49 170 555 0505",
        "location": "Medical practice",
        "source_ref": "google-linked-doctor-calendar",
        "source_name": "Google Doctor Demo Calendar",
        "source_external_id": "google-event-doctor-001",
        "booking_reference": "booking-gdemo-doctor-001",
        "start_at_utc": DEMO_REFERENCE_NOW_UTC + timedelta(days=2, hours=3),
        "duration_minutes": 30,
        "reminder_offsets_hours": [24, 2],
        "channel_priority": ["email", "rcs_sms"],
    },
    "technician": {
        ...
        "customer_name": "Lars Krueger",
        "customer_contact": "+49 170 555 0606",
        "location": "Customer site",
        "source_ref": "google-linked-technician-calendar",
        "source_name": "Google Technician Demo Calendar",
        "source_external_id": "google-event-technician-001",
        "booking_reference": "booking-gdemo-technician-001",
        "start_at_utc": DEMO_REFERENCE_NOW_UTC + timedelta(days=4, hours=2),
        "duration_minutes": 45,
        "reminder_offsets_hours": [24, 4],
        "channel_priority": ["email", "voice"],
    },
    "tee_time": {
        ...
        "customer_name": "Ben Fischer",
        "customer_contact": "+49 170 555 0707",
        "location": "Golf course",
        "source_ref": "google-linked-tee-time-calendar",
        "source_name": "Google Tee Time Demo Calendar",
        "source_external_id": "google-event-tee-time-001",
        "booking_reference": "booking-gdemo-tee-time-001",
        "start_at_utc": DEMO_REFERENCE_NOW_UTC + timedelta(days=5, hours=5),
        "duration_minutes": 60,
