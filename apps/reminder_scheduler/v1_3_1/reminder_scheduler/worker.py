...
class ReminderSchedulerWorker:
    ...
    v1.3.1 keeps the worker intentionally small but makes the lifecycle rules
    explicit: planning may rebuild the future set, dispatch claims a job before
    delivery, and the next cycle can reclaim expired locks safely.
    """
