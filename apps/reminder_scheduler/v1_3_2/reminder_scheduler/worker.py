...
class ReminderSchedulerWorker:
    """Polling worker for reminder planning and dispatch.

    v1.3.2 intentionally keeps the worker thin. All time calculations are
    delegated to the service/calculator path so the worker cannot drift away
    from the preview logic.
    """
