...
router = APIRouter(prefix="/api/reminders/v1.3.5", tags=["reminder-scheduler-v1.3.5"])
app = FastAPI(title="Appointment Reminder Scheduler v1.3.5")
...
def root_view() -> dict[str, object]:
    return {
        "module": "reminder_scheduler",
        "version": "v1.3.5",
        "help_path": "/api/reminders/v1.3.5/help",
        "health_path": "/api/reminders/v1.3.5/health",
    }
